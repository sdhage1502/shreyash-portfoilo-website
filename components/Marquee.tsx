...
const Marquee: React.FC = () => {
  ...
  return (
    <div className="relative w-full py-10 md:py-14 overflow-hidden bg-[#080808] border-y border-white/[0.03]">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[10vh] bg-[var(--accent)]/5 blur-[100px] pointer-events-none opacity-40" />
        ...
        {duplicatedItems.map((item, i) => (
          <div key={i} className="flex items-center gap-16 md:gap-24 group">
            ...
            <div className="flex items-center gap-4">
              <div className="h-[1px] w-8 bg-white/10 group-hover:bg-[var(--accent)]/40 transition-colors" />
              <div className="w-1.5 h-1.5 rounded-sm bg-white/10 group-hover:bg-[var(--accent)] group-hover:shadow-[0_0_10px_var(--accent)] transition-all duration-500" />
              <div className="h-[1px] w-8 bg-white/10 group-hover:bg-[var(--accent)]/40 transition-colors" />
            </div>

    ...
    <section id="education" className="py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-full sm:max-w-4xl lg:max-w-5xl mx-auto">
        {educationData.map((edu, i) => (
          <motion.div
            key={i}
            className={`group relative bg-gradient-to-br from-[#fdf4f6] to-[#f8e6eb] dark:from-[#2a0a12] dark:to-[#3a0f1a] backdrop-blur-xl rounded-3xl p-4 sm:p-6 lg:p-8 shadow-xl border border-white/20 dark:border-neutral-700/30 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer ${
              activeTab === `education-${i}` ? 'ring-2 ring-[#7b112c] dark:ring-[#d23b55]' : ''
            }`}
          ...
          >
            ...
            <div className="relative z-10 flex items-start space-x-4 sm:space-x-6">
              <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-[#7b112c] to-[#a1162f] rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
              ...
              <div className="flex-grow">
                ...
                <p className="text-base sm:text-lg font-semibold text-[#7b112c] dark:text-[#f2c7d0] mb-1">
                  {edu.school}
                </p>

  ...
  return (
    <section id="experience" className="py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
      <div className="text-center space-y-4 sm:space-y-6 relative">
        ...
        <div className="relative">
          <div className="inline-flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#7b112c] to-[#a1162f] rounded-2xl flex items-center justify-center shadow-lg">
              <span className="material-symbols-outlined text-white text-lg sm:text-xl">work</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[#7b112c] via-[#a1162f] to-[#d23b55] bg-clip-text text-transparent">
              Experience
            </h2>
          </div>
          <div className="w-20 sm:w-24 h-1 sm:h-1.5 bg-gradient-to-r from-[#7b112c] via-[#a1162f] to-[#d23b55] mx-auto rounded-full shadow-lg"></div>
      ...
      <div className="relative max-w-full sm:max-w-4xl lg:max-w-6xl mx-auto">
        <div className="absolute left-6 sm:left-8 md:left-1/2 transform md:-translate-x-1/2 w-1 h-full bg-gradient-to-b from-[#7b112c] via-[#a1162f] to-[#d23b55] rounded-full shadow-lg md:hidden sm:block"></div>

        <div className="absolute left-5 sm:left-7 md:left-1/2 transform md:-translate-x-1/2 top-16 sm:top-20">
          <div className="w-3 h-3 bg-[#7b112c] rounded-full animate-pulse opacity-75"></div>
          <div className="w-3 h-3 bg-[#a1162f] rounded-full animate-pulse opacity-75" style={{ animationDelay: '1s' }}></div>
        </div>

        {experienceData.map((exp, i) => (
          <div key={i} className="relative mb-8 sm:mb-12 md:mb-16">
            <div className="absolute left-4 sm:left-6 md:left-1/2 transform md:-translate-x-1/2 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-[#7b112c] to-[#a1162f] rounded-full border-4 border-white dark:border-neutral-900 shadow-xl animate-float z-10">
              <div className="w-full h-full bg-gradient-to-br from-[#a1162f] to-[#d23b55] rounded-full animate-pulse"></div>
            </div>
            ...
            <div className={`ml-12 sm:ml-16 md:ml-0 ${i % 2 === 0 ? 'md:mr-1/2 md:pr-8 lg:pr-16' : 'md:ml-1/2 md:pl-8 lg:pl-16'}`}>
              <motion.div
                className={`group relative bg-gradient-to-br ${exp.bgColor} backdrop-blur-xl rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-white/20 dark:border-neutral-700/30 hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden ${
                  activeTab === `experience-${i}` ? 'ring-2 ring-[#7b112c] dark:ring-[#d23b55]' : ''
                }`}
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-3 sm:mb-4">
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      ...
                      <div>
                        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-1 sm:mb-2 group-hover:text-[#7b112c] dark:group-hover:text-[#d23b55] transition-colors duration-300">
                          {exp.title}
                        </h3>
                        <div className="space-y-1">
                          <p className="text-base sm:text-lg font-semibold text-[#7b112c] dark:text-[#f2c7d0]">
                            {exp.company}
                          </p>
                    ...
                    <button
                      className="text-[#7b112c] dark:text-[#d23b55] hover:text-[#5a0b1f] dark:hover:text-[#f2c7d0] transition-colors duration-300"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-3 sm:mb-4">
                    {Object.entries(exp.metrics).map(([key, value]) => (
                      ...
                      >
                        <div className="text-lg sm:text-xl lg:text-2xl font-bold text-[#7b112c] dark:text-[#d23b55] mb-1">
                          {value}
                        </div>
                  ...
                  <div className="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4">
                    {exp.technologies.map((tech, j) => (
                      <span
                        key={j}
                        className="px-2 sm:px-3 py-1 sm:py-1.5 bg-gradient-to-r from-[#7b112c]/15 to-[#a1162f]/15 text-[#7b112c] dark:text-[#f2c7d0] rounded-full text-xs sm:text-sm font-medium border border-[#7b112c]/20 dark:border-[#a1162f]/30 hover:scale-105 transition-transform duration-200"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  >
                    <div className="border-t border-[#7b112c]/20 dark:border-[#a1162f]/30 pt-4 sm:pt-6">
                      <h4 className="text-base sm:text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-3 sm:mb-4 flex items-center">
                        <span className="material-symbols-outlined text-[#7b112c] dark:text-[#d23b55] mr-2 text-lg sm:text-xl">description</span>
                        Key Achievements
                      </h4>
                      <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                        {exp.achievements.map((achievement, j) => (
                          <li key={j} className="flex items-start space-x-2 sm:space-x-3 group/item">
                            <div className="w-2 h-2 bg-gradient-to-r from-[#7b112c] to-[#a1162f] rounded-full mt-2 sm:mt-2.5 flex-shrink-0 group-hover/item:scale-150 transition-transform duration-300"></div>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-[#7b112c]/20 dark:border-[#a1162f]/30 gap-3 sm:gap-4">
                    <div className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm text-neutral-600 dark:text-neutral-400">
                      <span className="material-symbols-outlined text-[#7b112c] dark:text-[#d23b55] text-sm sm:text-base">trending_up</span>
                      <span>Currently Active</span>
                    </div>
                    <button
                      className="px-4 sm:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-[#7b112c] to-[#a1162f] text-white font-medium rounded-xl hover:from-[#5a0b1f] hover:to-[#7b112c] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm"
      ...
      <div className="text-center mt-8 sm:mt-12 lg:mt-16 p-4 sm:p-6 lg:p-8 bg-gradient-to-r from-[#fdf4f6] to-[#f8e6eb] dark:from-[#2a0a12] dark:to-[#3a0f1a] rounded-3xl border border-[#7b112c]/20 dark:border-[#a1162f]/30">
        <div className="flex items-center justify-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
          <span className="material-symbols-outlined text-[#7b112c] dark:text-[#d23b55] text-xl sm:text-2xl lg:text-3xl">handshake</span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 lg:space-x-4">
          <a
            ...
            className="px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-[#7b112c] to-[#a1162f] text-white font-semibold rounded-xl hover:from-[#5a0b1f] hover:to-[#7b112c] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm"

...
const Footer = () => {
  ...
  return (
    <footer className="glass-morphism shadow-inner border-t border-neutral-200/50 dark:border-neutral-700/50 py-6 sm:py-8 lg:py-10 px-4 sm:px-6 lg:px-8 mt-12 sm:mt-16 lg:mt-24 relative">
      <div className="absolute inset-0 top-0 w-full h-px bg-gradient-to-r from-transparent via-emerald-400 to-transparent animate-shimmer"></div>
      ...
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between text-center sm:text-left space-y-6 sm:space-y-0 gap-4 sm:gap-0">
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 lg:gap-6">
          {navLinks.map((link, i) => (
            <a
              key={i}
              href={link.href}
              className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors duration-300"
        ...
        <div className="flex items-center justify-center gap-3 sm:gap-4">
          <div className="flex justify-center gap-3 sm:gap-4">
            {socialLinks.map((social, i) => (
              <a
                ...
                className="group flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 lg:w-11 lg:h-11 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full text-white transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-110 relative overflow-hidden"
              >
          ...
          <button
            ...
            className="group flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 lg:w-11 lg:h-11 bg-gradient-to-br from-cyan-500 to-teal-600 rounded-full text-white transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-110 relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-white/20 scale-0 group-hover:scale-100 transition-transform duration-300 rounded-full"></div>
            <span className="material-symbols-outlined text-base sm:text-lg lg:text-xl group-hover:scale-110 transition-transform duration-300 relative z-10">
              arrow_upward

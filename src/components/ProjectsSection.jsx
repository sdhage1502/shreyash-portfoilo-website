      ...
      <div className="text-center space-y-4 sm:space-y-6 relative">
        ...
        <div className="relative">
          <div className="inline-flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
            ...
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[#7b112c] via-[#a1162f] to-[#d23b55] bg-clip-text text-transparent">
              Projects
            </h3>
          </div>
        ...
        {projectsData.map((project, i) => (
          <motion.div
            ...
            className={`group relative bg-white/70 dark:bg-neutral-900/60 rounded-3xl p-4 sm:p-6 lg:p-8 shadow-xl border border-white/20 dark:border-neutral-700/30 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer overflow-hidden ${
              activeTab === `project-${i}` ? 'ring-2 ring-[#7b112c] dark:ring-[#d23b55]' : ''
            }`}
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-3 sm:mb-4">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-[#7b112c] dark:group-hover:text-[#d23b55] transition-colors duration-300">
                      {project.title}
                    </h4>
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 lg:space-x-4 mt-4 sm:mt-6 border-t border-[#7b112c]/20 dark:border-[#a1162f]/30 pt-4 sm:pt-6">
                {project.links.live && (
                  <a
                    href={project.links.live}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 sm:px-5 py-1.5 sm:py-2 bg-gradient-to-r from-[#7b112c] to-[#a1162f] text-white font-medium rounded-xl hover:from-[#5a0b1f] hover:to-[#7b112c] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center space-x-1 sm:space-x-2 text-xs sm:text-sm"
                  >
                ...
                {project.links.github && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 sm:px-5 py-1.5 sm:py-2 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 font-medium rounded-xl border border-[#7b112c]/20 dark:border-[#a1162f]/30 hover:bg-[#fdf4f6] dark:hover:bg-[#2a0a12] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center space-x-1 sm:space-x-2 text-xs sm:text-sm"
                  >
